...
func init() {
	...
	txClient = opb.NewClient(cfg, nil)

	// 导入私钥
	address, _ = txClient.Key.Recover("validator", "12345678", "tool clinic access federal flight egg sand lonely book aunt plastic lemon either diagram water betray life gaze spice upon kingdom much coyote flat")
